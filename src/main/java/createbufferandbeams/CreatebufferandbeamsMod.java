...
public class CreatebufferandbeamsMod {
	public static final Logger LOGGER = LogManager.getLogger(CreatebufferandbeamsMod.class);
	public static final String MODID = "createbufferandbeams";

	public CreatebufferandbeamsMod() {
		MinecraftForge.EVENT_BUS.register(this);
		CreatebufferandbeamsModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		CreatebufferandbeamsModBlocks.REGISTRY.register(bus);
		CreatebufferandbeamsModItems.REGISTRY.register(bus);

		CreatebufferandbeamsModMenus.REGISTRY.register(bus);
